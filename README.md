...
Production entrypoint: `https://github.echo-op.com/oauth/start`. Session state is available at `GET /session`; `POST /logout` revokes the durable session and clears the cookie.
